...
class RandomMeals {
  @JsonKey(name: "meals")
  List<RandomMealsItem> randomMealsItem;

  RandomMeals({this.randomMealsItem});

  @override
  String toString() {
    return 'RandomMeals{randomMealsItem: $randomMealsItem}';
  }

  factory RandomMeals.fromJson(Map<String, dynamic> json) =>
      _$RandomMealsFromJson(json);

  Map<String, dynamic> toJson() => _$RandomMealsToJson(this);
}

@JsonSerializable()
class RandomMealsItem {
  String idMeal;
  String strMeal;
