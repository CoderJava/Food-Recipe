...
SearchMeals _$SearchMealsFromJson(Map<String, dynamic> json) {
  return SearchMeals(
      searchMealsItems: (json['meals'] as List)
          ?.map((e) => e == null
              ? null
              : SearchMealsItem.fromJson(e as Map<String, dynamic>))
          ?.toList());
}

Map<String, dynamic> _$SearchMealsToJson(SearchMeals instance) =>
    <String, dynamic>{'meals': instance.searchMealsItems};

SearchMealsItem _$SearchMealsItemFromJson(Map<String, dynamic> json) {
  return SearchMealsItem(
...
Map<String, dynamic> _$SearchMealsItemToJson(SearchMealsItem instance) =>
    <String, dynamic>{
