...
part of 'latest_meals.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

LatestMeals _$LatestMealsFromJson(Map<String, dynamic> json) {
  return LatestMeals(
      latestMealsItems: (json['meals'] as List)
          ?.map((e) => e == null
              ? null
              : LatestMealsItem.fromJson(e as Map<String, dynamic>))
          ?.toList());
}

Map<String, dynamic> _$LatestMealsToJson(LatestMeals instance) =>
    <String, dynamic>{'meals': instance.latestMealsItems};

LatestMealsItem _$LatestMealsItemFromJson(Map<String, dynamic> json) {
  return LatestMealsItem(
...
Map<String, dynamic> _$LatestMealsItemToJson(LatestMealsItem instance) =>
    <String, dynamic>{
