...
class SearchMeals {
  ...
  @override
  String toString() {
    return 'SearchMeals{searchMealsItems: $searchMealsItems}';
  }

  factory SearchMeals.fromJson(Map<String, dynamic> json) => _$SearchMealsFromJson(json);
...
class SearchMealsItem {
  ...
  SearchMealsItem({this.idMeal, this.strMeal, this.strDrinkAlternate,
      ...
      this.strTags, this.strYoutube, this.strIngredient1, this.strIngredient2,
      ...
      this.strIngredient15, this.strIngredient16, this.strIngredient17,
      this.strIngredient18, this.strIngredient19, this.strIngredient20,
