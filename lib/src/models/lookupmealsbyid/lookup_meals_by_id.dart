...
part 'lookup_meals_by_id.g.dart';

@JsonSerializable()
class LookupMealsById {
  @JsonKey(name: "meals")
  List<LookupMealsByIdItem> lookupMealsbyIdItems;

  LookupMealsById({this.lookupMealsbyIdItems});

  @override
  String toString() {
    return 'LookupMealsById{lookupMealsbyIdItems: $lookupMealsbyIdItems}';
  }

  factory LookupMealsById.fromJson(Map<String, dynamic> json) =>
      _$LookupMealsByIdFromJson(json);

  Map<String, dynamic> toJson() => _$LookupMealsByIdToJson(this);
}

@JsonSerializable()
class LookupMealsByIdItem {
  String idMeal;
  String strMeal;
