...
part 'latest_meals.g.dart';

@JsonSerializable()
class LatestMeals {
  @JsonKey(name: "meals")
  List<LatestMealsItem> latestMealsItems;

  LatestMeals({this.latestMealsItems});

  @override
  String toString() {
    return 'LatestMeals{latestMealsItems: $latestMealsItems}';
  }

  factory LatestMeals.fromJson(Map<String, dynamic> json) =>
      _$LatestMealsFromJson(json);

  Map<String, dynamic> toJson() => _$LatestMealsToJson(this);
}

@JsonSerializable()
class LatestMealsItem {
  String idMeal;
  String strMeal;
